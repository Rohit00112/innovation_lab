    ...
    <div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <Card className="p-8 max-w-4xl mx-auto space-y-8">
            <div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                experience and collect usage data. You can control cookie preferences
                through your browser settings. By continuing to use our website, you
            ...
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Email: privacy@innovationlab.com<br />
